...
export function AskView() {
  ...
  // Entry point for every call site — stream the answer directly. No disambiguation
  // pre-check: the assistant answers instead of re-asking on an ambiguous mention.
  const submit = (text: string, geography: string = geo) => {
    runStream(text, geography);
  };
